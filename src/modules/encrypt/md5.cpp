/**
 * @file md5.cpp
 * @brief easyVim MD5加密算法
 * @note the file is from https://github.com/ZTao-z/WebSecurity.git
 * @note 该文件是从 https://github.com/ZTao-z/WebSecurity.git 中修改而来的，用于实现MD5加密算法
 * @author ZTao-z@github
 * @license MIT
 */
#include<string>
#include<vector>
...
/****** below is modified by redhecker@github to match the project **********/
// int main() {
//     MD5 test;
//     string a = "";
//     cout << "Plain Text: ";
...
string ev::md5(string input) {
    MD5 modle;
    return modle.encode(input);
}